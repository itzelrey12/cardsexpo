...
class CardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color(0xFF82C8E9),
        appBar: AppBar(
          title: Text('Cards'),
        ),
  ...
  Card card2() {
    return Card(
      ...
      elevation: 50,
      color: Color(0xFF8DF089),
      child: Column(
        children: <Widget>[
          Image.network(
              'https://foodandtravel.mx/wp-content/uploads/2017/05/entrada.png'),
          Container(
